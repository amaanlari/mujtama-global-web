                ...
                <div
                    ...
                    <div className="h-[323px] inline-flex flex-col justify-start items-start gap-10">
                        ...
                        <div
                            ...
                            the heart of Mujtama is a vision to bridge tradition with innovation. Our team is dedicated
                            to
                            integrating modern technology and AI to enhance the way Muslims around the world engage with

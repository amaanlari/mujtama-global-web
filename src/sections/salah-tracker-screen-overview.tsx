        ...
        <>
            ...
            <div className={"lg:hidden"}>
                <div
                    ...
                    <div className="self-stretch flex flex-col justify-start items-start gap-[5px]">
                        <div
                            className="self-stretch justify-center text-black text-xl font-semibold font-['Montserrat'] leading-7 tracking-wide">Salah
                            Tracker Screen Overview
                        </div>
                        <div
                            className="self-stretch justify-center text-black text-sm font-normal font-['Montserrat'] leading-tight tracking-wide">Build
                            a consistent prayer habit by tracking your daily Salah in a simple and organized way. This
                            screen helps you stay accountable with just a few taps.
                        </div>
                    </div>
                    <div>
                    ...
                    <div className="self-stretch flex flex-col justify-start items-start gap-2.5">
                        <div className="self-stretch flex flex-col justify-start items-start gap-[5px]">
                            <div
                                className="self-stretch justify-center text-black text-base font-medium font-['Montserrat'] leading-snug tracking-tight">Prayer
                                Check-in Prompt
                            </div>
                            <div
                                className="self-stretch justify-center text-[#626262] text-sm font-normal font-['Montserrat'] leading-tight tracking-wide">At
                                the top, you’ll see a quick question like “Have you prayed Maghrib?” — tap ‘Yes’ to
                                instantly log your prayer.
                            </div>
                        </div>
                        <div className="self-stretch flex flex-col justify-start items-start gap-[5px]">
                            <div
                                className="self-stretch justify-center text-black text-base font-medium font-['Montserrat'] leading-snug tracking-tight">Calendar
                                View
                            </div>
                            <div
                                className="self-stretch justify-center text-[#626262] text-sm font-normal font-['Montserrat'] leading-tight tracking-wide">Scroll
                                through the calendar to select any date and view or update your prayer history. It helps
                                you track your progress over time.
                            </div>
                        </div>
                        <div className="self-stretch flex flex-col justify-start items-start gap-[5px]">
                            <div
                                className="self-stretch justify-center text-black text-base font-medium font-['Montserrat'] leading-snug tracking-tight">Daily
                                Salah Checklist
                            </div>
                            <div
                                className="self-stretch justify-center text-[#626262] text-sm font-normal font-['Montserrat'] leading-tight tracking-wide">Each
                                day shows all five prayers. Tap to mark them as completed and visually track which ones
                                you've prayed.
                            </div>
                        </div>
                        <div className="self-stretch flex flex-col justify-start items-start gap-[5px]">
                            <div
                                className="self-stretch justify-center text-black text-base font-medium font-['Montserrat'] leading-snug tracking-tight">Current
                                Day Highlight
                            </div>
                            <div
                                className="self-stretch justify-center text-[#626262] text-sm font-normal font-['Montserrat'] leading-tight tracking-wide">The
                                current date is highlighted so you always know which day you’re logging for.
                            </div>
                        </div>
                    </div>

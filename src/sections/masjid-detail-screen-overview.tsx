                    ...
                    <div className="w-[590px] inline-flex flex-col justify-start items-center gap-5">
                        <div className="self-stretch flex flex-col justify-start items-start gap-[5px]">
                            ...
                            <div
                                ...
                                helps you track prayer times, find directions, and manage your mosque preferences with
                                ease.
                            </div>
                        </div>
                            ...
                            <div
                                ...
                                <div className="size- inline-flex flex-col justify-start items-start gap-1">
                                    ...
                                    <div
                                        ...
                                        the top, see how much time is left until the next prayer. This real-time
                                        countdown
                            ...
                            <div
                                ...
                                <div className="size- inline-flex flex-col justify-start items-start gap-1">
                                    ...
                                    <div
                                        ...
                                        full details of the mosque including name, address, and distance from your
                                        current
                                        location. Tap “Direction” to navigate or “Following” to keep it in your
                                        favorites.
                                    </div>
                                </div>
                            </div>
                            <div
                                ...
                                <div className="size- inline-flex flex-col justify-start items-start gap-1">
                                    ...
                                    <div
                                        ...
                                        all five daily prayer times along with Jummah. The currently active or next
                                        prayer
